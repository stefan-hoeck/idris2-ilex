...
parameters {0 e,a    : Type}
  ...
  loop :
    ...
    -> {auto x : Ix pos n}             -- position in the byte array
    -> Either (Bounded $ InnerError a e) (SnocList (Bounded a))
  loop next term vals 0     = Right vals
  loop next term vals (S k) =
