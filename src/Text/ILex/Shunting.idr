...
record ShuntTerm (t,p,o : Type) where
  constructor ST
  preOps  : List (ByteBounded p, Nat)
  term    : t
  postOps : List (ByteBounded o, Nat)

%runElab derive "ShuntTerm" [Show,Eq]

public export
record ShuntItem (t,p,i,o : Type) where
  constructor SI
  term    : ShuntTerm t p o
  op      : ByteBounded i
  prec    : Nat
  assoc   : Assoc

%runElab derive "ShuntItem" [Show,Eq]

public export
0 SnocItms : (t,p,i,o : Type) -> Type
SnocItms t p i o = SnocList (ShuntItem t p i o)

public export
0 Itms : (t,p,i,o : Type) -> Type
Itms t p i o = List (ShuntItem t p i o)
...
--         in Right $ si:<i:<TInf lst op n a
  ...
  impl : SnocItms t p i o -> Itms t p i o -> ShuntTerm t p o -> Either (ByteBounded e) t
